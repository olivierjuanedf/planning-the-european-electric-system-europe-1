...
data1 = pd.read_csv(f'/workspaces/planning-the-european-electric-system-europe-1/data/ERAA_2023-2/demand/cy_stress-test/demand_2025_benelux.csv', sep=';')
data2 = pd.read_csv(f'/workspaces/planning-the-european-electric-system-europe-1/data/ERAA_2023-2/demand/demand_2025_benelux.csv', sep=';')
