# -*- coding: utf-8 -*-
"""
First very simple toy Unit Commitment model of Scandinavia zone - alone -> with PyPSA and ERAA data
"""
import warnings
...
uc_run_params = UCRunParams(selected_countries=selected_countries, selected_target_year=year, 
                            ...
                            selected_prod_types={"scandinavia": agg_prod_types_selec},
...
# III.1) Get data for Scandinavia... just for test -> data used when writing PyPSA model will be re-obtained afterwards
...
"""
IV) Build PyPSA model - with unique country (Scandinavia here)
"""
...
#################################################
# KEY POINT: main parameters needed for Scandinavia description in PyPSA are set in script
# long_term_uc.toy_model_params.scandinavia_parameters.py
...
# N.B. Scandinavia coordinates set randomly! (not useful in the calculation that will be done this week)
from long_term_uc.toy_model_params.scandinavia_parameters import gps_coords
coordinates = {"scandinavia": gps_coords}
...
# Almost "real Scandinavia"... excepting hydraulic storage and Demand-Side Response capacity 
...
from long_term_uc.toy_model_params.scandinavia_parameters import get_generators
# IV.4.1) get generators to be set on the unique considered bus here 
# -> from long_term_uc.toy_model_params.scandinavia_parameters.py script
...
# saved in file output/long_term_uc/figures/prod_scandinavia_{year}_{period start, under format %Y-%m-%d}.png
...
# -> saved in file output/long_term_uc/figures/prices_scandinavia_{year}_{period start, under format %Y-%m-%d}.png
