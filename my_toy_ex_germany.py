...
uc_run_params = UCRunParams(selected_countries=selected_countries, selected_target_year=year, 
                            ...
                            selected_prod_types={"germany": agg_prod_types_selec},
...
# III.1) Get data for Germany... just for test -> data used when writing PyPSA model will be re-obtained afterwards
...
# Almost "real Germany"... excepting hydraulic storage and Demand-Side Response capacity 
...
from long_term_uc.toy_model_params.germany_parameters import get_generators
# IV.4.1) get generators to be set on the unique considered bus here 
# -> from long_term_uc.toy_model_params.germany_parameters.py script
