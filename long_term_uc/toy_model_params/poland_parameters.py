...
def get_generators(country_trigram: str, fuel_sources: Dict[str, FuelSources],
    ...
    generators = [        
        ...
        {"name": f"Gas_{country_trigram}", "carrier": "Gas", "p_nom": 3728.82,
        "p_min_pu": 0, "p_max_pu": 1,
        "marginal_cost": fuel_sources["Gas"].primary_cost * 0.5,
        "efficiency": 0.5, "committable": False},
        {"name": f"Lignite_{country_trigram}", "carrier": "Lignite", "p_nom": 6961,
        "p_min_pu": 0, "p_max_pu": 1,
        "marginal_cost": fuel_sources["Lignite"].primary_cost * 0.5,
        "efficiency": 0.5, "committable": False},
        ...
        "efficiency": 1, "committable": False},
        # {"name": f"Hydro_{country_trigram}", "carrier": "Hydro",
        # "p_nom": 0, "p_min_pu": 0, "p_max_pu": 1, "marginal_cost": 0,
        # "efficiency": 1, "committable": False},
